  ...
  return (
    <View className={`flex-row items-center mb-4 items-center ${className || ""}`}>
      ...
      <View className="flex-1">
        ...
        {subText && <Text className="text-white text-base font-interMedium">{subText}</Text>}
      </View>

      {children && <View className="flex ml-auto items-center justify-center">{children}</View>}
    </View>
  );
}
